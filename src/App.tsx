...
function ChartPointDot({ cx, cy, payload, value, color, showRate = false }) {
...
function IngresosPage({ data, ...sharedHeaderProps }) {
...
function VinculacionPage({ data, ...sharedHeaderProps }) {
...
function TransaccionalesPage({ data, ...sharedHeaderProps }) {
  return (
    <div className="app-shell">
      <div
        className="container"
...
function NpsPage({ data, ...sharedHeaderProps }) {
  return (
    <div className="app-shell">
      <div
        className="container"
